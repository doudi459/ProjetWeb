        ...
        <div class="page-wrapper" style="min-height: 591px;background-color: rgb(30,30,30); ">
           ...
           <div class="container-fluid">
            ...
            <div class="row">
                           ...
                           <button type="button" class="btn btn-outline-info btn-sm">Ajouter page</button>
                           </div>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>Mark 
                                    ...
                                    <div class="btn-group btn-group-xs" role="group" style="margin-left :5%;">
                                    <button type="button" class="btn btn-link btn-sm" style="padding-right: 3px;">Voir</button>
                                    <span class="vl"></span>
                                    <button type="button" class="btn btn-link btn-sm" style="padding: 3px; color: red">Supprimer</button>
                                    <span class="vl"></span>
                                    <button type="button" class="btn btn-link btn-sm" style="padding-left: 3px;">Editer</button>  
                                    </div>
